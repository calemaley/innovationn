...
// Function to send the confirmation emails
        ...
        const interval = setInterval(async () => {
            try {
                ...
                if (response.ok && data.status === 'success') {
                    ...
                    // Send emails with meeting details if they exist
                    sendConfirmationEmails(email, amount, reference, meetingDetails);

                    // Forward all params to the thank you page
                    const queryParams = new URLSearchParams({
                        email, amount, reference, ...meetingDetails
                    }).toString();
                    ...
                    setStatus(`Current status: ${data.status}. Please wait...`);
                }
